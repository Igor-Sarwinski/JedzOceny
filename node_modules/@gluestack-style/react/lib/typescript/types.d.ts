...
export type UtilityProps<GenericComponentStyles> = TokenizedRNStyleProps<GetRNStyles<GenericComponentStyles>> & AliasesProps<RNStyles<GenericComponentStyles>>;
/********************* UTILITY TYPE *****************************************/
...
type WithSizeNegativeValue<Tokens> = keyof Tokens extends 'sizes' ? WithNegativeValue<StringifyToken<keyof Tokens['sizes']> | StringifyToken<keyof Tokens['space']>> : WithNegativeValue<StringifyToken<keyof Tokens['space']>>;
