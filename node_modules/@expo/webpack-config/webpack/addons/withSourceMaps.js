...
function createSourceMapPlugin(webpackConfig, env = {}) {
    ...
    new webpack_1.SourceMapDevToolPlugin({
        ...
        filename: (_b = webpackConfig.output) === null || _b === void 0 ? void 0 : _b.sourceMapFilename,
        // @ts-ignore: this is how webpack works internally
        moduleFilenameTemplate: (_c = webpackConfig.output) === null || _c === void 0 ? void 0 : _c.devtoolModuleFilenameTemplate,
